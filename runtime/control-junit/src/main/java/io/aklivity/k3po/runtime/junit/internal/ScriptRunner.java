...
public final class ScriptRunner implements Callable<ScriptPair> {
    ...
    public ScriptRunner(URL controlURL, List<String> names, Latch latch, List<String> overridenScriptProperties) {
