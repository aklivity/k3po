 ...
 * under the License.
 */
package io.aklivity.k3po.runtime.maven.plugin.internal;
...
import io.aklivity.k3po.runtime.maven.plugin.internal.logging.MavenLoggerFactory;
...
public class StartMojo extends AbstractMojo {
    ...
    protected void executeImpl() throws MojoExecutionException {
        ...
        try {
            ...
            Plugin plugin = (Plugin) pluginsAsMap.get("io.aklivity.k3po:k3po-maven-plugin");
            if (plugin != null)
            {
