...
public class ChildClosedHandlerTest {

    private Mockery context;
    private ChannelUpstreamHandler upstream;
    private ChannelPipeline pipeline;
    private ChannelFactory channelFactory;
    private ChildClosedHandler handler;
    ...
    public void setUp() throws Exception {
        ...
        handler = new ChildClosedHandler();
    ...
    @Test
    public void shouldPropagateUpstreamChildClosedEventAfterFutureDone() throws Exception {
