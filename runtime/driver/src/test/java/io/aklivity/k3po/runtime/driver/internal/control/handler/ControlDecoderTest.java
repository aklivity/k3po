...
import io.aklivity.k3po.runtime.driver.internal.control.AbortMessage;
import io.aklivity.k3po.runtime.driver.internal.control.PrepareMessage;
import io.aklivity.k3po.runtime.driver.internal.control.StartMessage;
import io.aklivity.k3po.runtime.driver.internal.control.handler.ControlDecoder;
...
public class ControlDecoderTest {
    ...
    public void shouldDecodePrepareMessage() throws Exception {
        ...
        String path = "io/aklivity/k3po/runtime/driver/control/handler/testScript.rpt";
    ...
    public void shouldDecodeMultipleMessages() throws Exception {
        ...
        // @formatter:off
        String path = "io/aklivity/k3po/runtime/driver/control/handler/emptyScript.rpt";
