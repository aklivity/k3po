...
public class ReadHandler extends AbstractEventHandler {
    ...
    {
        return (config instanceof io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.channel.ChannelConfig) &&
                "message".equals(((io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.channel.ChannelConfig)config).getAlignment());
    }
}
