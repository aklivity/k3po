...
public class TlsClientChannelFactory implements ChannelFactory {
    ...
    public TlsClientChannelFactory(TlsClientChannelSinkFactory channelSinkFactory) {
        this.channelSinkFactory = channelSinkFactory;
    }

    @Override
    public TlsClientChannel newChannel(ChannelPipeline pipeline) {
        return new TlsClientChannel(this, pipeline, channelSinkFactory.newChannelSink());
    }
