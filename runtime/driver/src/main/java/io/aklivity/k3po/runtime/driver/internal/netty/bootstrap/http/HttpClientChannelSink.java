...
import static io.aklivity.k3po.runtime.driver.internal.channel.Channels.chainFutures;
import static io.aklivity.k3po.runtime.driver.internal.channel.Channels.chainWriteCompletes;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpClientChannel.HttpWriteState.CONTENT_BUFFERED;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpClientChannel.HttpWriteState.CONTENT_CHUNKED;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpClientChannel.HttpWriteState.CONTENT_COMPLETE;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpClientChannel.HttpWriteState.CONTENT_STREAMED;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpClientChannel.HttpWriteState.UPGRADEABLE;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpRequestForm.ABSOLUTE_FORM;
import static io.aklivity.k3po.runtime.driver.internal.netty.bootstrap.http.HttpRequestForm.ORIGIN_FORM;
