...
public class TlsServerChannel extends AbstractServerChannel<TlsServerChannelConfig> {

    TlsServerChannel(ChannelFactory factory, ChannelPipeline pipeline, ChannelSink sink) {
        super(factory, pipeline, sink, new DefaultTlsServerChannelConfig());
    }
